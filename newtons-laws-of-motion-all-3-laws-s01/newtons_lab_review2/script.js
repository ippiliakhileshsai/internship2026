...
const TRANSLATIONS = {
  en: {
    ...
    langSub:        "Learn Newton's Laws in your own language!",
    a11yTitle:      "Accessibility for Blind Kids",
    a11ySub:        "Special features to help everyone learn!",
    contrastLabel:  "High Contrast Mode",
    contrastDesc:   "Bold black & white colours — easier to see!",
    largeTextLabel: "Large Text Mode",
    largeTextDesc:  "Bigger letters — easier to read for everyone!",
    ttsLabel:       "Read Aloud (Text-to-Speech)",
    ttsDesc:        "Press any section heading to hear it read out loud!",
    keyNavLabel:    "Keyboard Navigation",
    keyNavDesc:     "Use Tab & Enter keys to move through the page!",
    motionLabel:    "Reduce Animations",
    motionDesc:     "Fewer moving things — less distracting!",
    a11yTip:        "Tip: Screen readers like NVDA and VoiceOver work great with this page! All buttons and images have descriptions built in. 🎉",
    ttsNewton:      "👨‍🔬 About Newton",
    ttsLaw1:        "📌 Law 1 — Inertia",
    ttsLaw2:        "📌 Law 2 — F=ma",
    ttsLaw3:        "📌 Law 3 — Action & Reaction",
    heroTitle:      "Newton's Laws of Motion for Kids! 🌟",
    heroSub:        "Discover how things move with fun animations and interactive experiments!",
    lawPreview:     "Newton's First Law: Objects at rest stay at rest unless acted upon by a force! 🍎",
    law1Title:      "Law of Inertia",
    law1Desc:       "Things don't move by themselves — they need a push or pull!",
    law2Title:      "Force = Mass × Acceleration",
    law2Desc:       "Push harder → go faster! Heavier objects need more force to move.",
    law3Title:      "Action & Reaction",
    law3Desc:       "Every push has an equal push back! Forces always come in pairs.",
    navNewton:      "👨‍🔬 About Newton",
    navLaws:        "📖 The Laws",
    navSim:         "🧬 Simulate",
    navGames:       "🎮 Games",
    navQuiz:        "❓ Quiz",
  ...
  te: {
    ...
    langSub:        "మీ స్వంత భాషలో న్యూటన్ నియమాలు నేర్చుకోండి!",
    a11yTitle:      "అంధ పిల్లల కోసం అందుబాటు",
    a11ySub:        "అందరికీ నేర్చుకోవటానికి ప్రత్యేక సౌకర్యాలు!",
    contrastLabel:  "అధిక కాంట్రాస్ట్ మోడ్",
    contrastDesc:   "చూడడం సులభంగా ఉండే ముదురు రంగులు!",
    largeTextLabel: "పెద్ద అక్షరాల మోడ్",
    largeTextDesc:  "పెద్ద అక్షరాలు — చదవడం సులభం!",
    ttsLabel:       "చదివి వినిపించు (టెక్స్ట్-టు-స్పీచ్)",
    ttsDesc:        "ఏదైనా శీర్షికను నొక్కి వినండి!",
    keyNavLabel:    "కీబోర్డ్ నావిగేషన్",
    keyNavDesc:     "Tab & Enter కీలు ఉపయోగించండి!",
    motionLabel:    "యానిమేషన్లు తగ్గించు",
    motionDesc:     "తక్కువ కదలికలు — తక్కువ దృష్టి మరలు!",
    a11yTip:        "చిట్కా: NVDA మరియు VoiceOver వంటి స్క్రీన్ రీడర్లు ఈ పేజీతో అద్భుతంగా పని చేస్తాయి! 🎉",
    ttsNewton:      "👨‍🔬 న్యూటన్ గురించి",
    ttsLaw1:        "📌 నియమం 1 — జడత్వం",
    ttsLaw2:        "📌 నియమం 2 — F=ma",
    ttsLaw3:        "📌 నియమం 3 — చర్య & ప్రతిచర్య",
    heroTitle:      "పిల్లల కోసం న్యూటన్ చలన నియమాలు! 🌟",
    heroSub:        "సరదా యానిమేషన్లు మరియు ప్రయోగాలతో చలనం ఎలా జరుగుతుందో తెలుసుకోండి!",
    lawPreview:     "న్యూటన్ మొదటి నియమం: బాహ్య శక్తి వర్తించకపోతే విశ్రాంతిలో ఉన్న వస్తువు విశ్రాంతిలోనే ఉంటుంది! 🍎",
    law1Title:      "జడత్వ నియమం",
    law1Desc:       "వస్తువులు తమంత తాముగా కదలవు — వాటికి నెట్టడం లేదా లాగడం అవసరం!",
    law2Title:      "బలం = ద్రవ్యరాశి × త్వరణం",
    law2Desc:       "గట్టిగా నెట్టండి → వేగంగా వెళ్ళండి! బరువైన వస్తువులకు ఎక్కువ బలం అవసరం.",
    law3Title:      "చర్య & ప్రతిచర్య",
    law3Desc:       "ప్రతి నెట్టడానికి సమానమైన తిరుగు నెట్టడం ఉంటుంది! శక్తులు జంటలుగా వస్తాయి.",
    navNewton:      "👨‍🔬 న్యూటన్",
    navLaws:        "📖 నియమాలు",
    navSim:         "🧬 అనుకరణ",
    navGames:       "🎮 ఆటలు",
    navQuiz:        "❓ క్విజ్",
    navSettings:    "⚙️ సెట్టింగ్స్",
    ttsLang:        "te-IN",
  },
  hi: {
    langTitle:      "अपनी भाषा चुनें",
    langSub:        "अपनी भाषा में न्यूटन के नियम सीखें!",
    a11yTitle:      "नेत्रहीन बच्चों के लिए सुगम्यता",
    a11ySub:        "सभी के सीखने के लिए विशेष सुविधाएँ!",
    contrastLabel:  "उच्च कंट्रास्ट मोड",
    contrastDesc:   "देखने में आसान गाढ़े रंग!",
    largeTextLabel: "बड़े अक्षर मोड",
    largeTextDesc:  "बड़े अक्षर — सभी के लिए पढ़ना आसान!",
    ttsLabel:       "जोर से पढ़ें (टेक्स्ट-टू-स्पीच)",
    ttsDesc:        "किसी भी शीर्षक को दबाएँ और सुनें!",
    keyNavLabel:    "कीबोर्ड नेविगेशन",
    keyNavDesc:     "Tab और Enter कुंजियों से पृष्ठ पर जाएँ!",
    motionLabel:    "एनिमेशन कम करें",
    motionDesc:     "कम हलचल — कम ध्यान भटकाव!",
    a11yTip:        "सुझाव: NVDA और VoiceOver जैसे स्क्रीन रीडर इस पृष्ठ के साथ बेहतरीन काम करते हैं! 🎉",
    ttsNewton:      "👨‍🔬 न्यूटन के बारे में",
    ttsLaw1:        "📌 नियम 1 — जड़त्व",
    ttsLaw2:        "📌 नियम 2 — F=ma",
    ttsLaw3:        "📌 नियम 3 — क्रिया & प्रतिक्रिया",
    heroTitle:      "बच्चों के लिए न्यूटन के गति के नियम! 🌟",
    heroSub:        "मजेदार एनिमेशन और प्रयोगों से जानें कि चीजें कैसे चलती हैं!",
    lawPreview:     "न्यूटन का पहला नियम: विराम में रखी वस्तु तब तक विराम में रहती है जब तक कोई बाहरी बल न लगे! 🍎",
    law1Title:      "जड़त्व का नियम",
    law1Desc:       "चीजें खुद नहीं हिलतीं — उन्हें धक्के या खिंचाव की जरूरत है!",
    law2Title:      "बल = द्रव्यमान × त्वरण",
    law2Desc:       "जोर से धकेलें → तेज जाएँ! भारी वस्तुओं को अधिक बल चाहिए।",
    law3Title:      "क्रिया & प्रतिक्रिया",
    law3Desc:       "हर धक्के का समान विपरीत प्रतिधक्का होता है! बल हमेशा जोड़े में आते हैं।",
    navNewton:      "👨‍🔬 न्यूटन",
    navLaws:        "📖 नियम",
    navSim:         "🧬 अनुकरण",
    navGames:       "🎮 खेल",
  ...
  ta: {
    langTitle:      "உங்கள் மொழியை தேர்ந்தெடுங்கள்",
    langSub:        "உங்கள் சொந்த மொழியில் நியூட்டன் விதிகளை கற்றுக்கொள்ளுங்கள்!",
    a11yTitle:      "பார்வையற்ற குழந்தைகளுக்கான அணுகல்",
    a11ySub:        "அனைவரும் கற்க உதவும் சிறப்பு அம்சங்கள்!",
    contrastLabel:  "அதிக மாறுபாடு பயன்முறை",
    contrastDesc:   "பார்க்க எளிதான அடர் வண்ணங்கள்!",
    largeTextLabel: "பெரிய எழுத்து பயன்முறை",
    largeTextDesc:  "பெரிய எழுத்துக்கள் — படிக்க எளிது!",
    ttsLabel:       "சத்தமாக படி (டெக்ஸ்ட்-டு-ஸ்பீச்)",
    ttsDesc:        "எந்த தலைப்பையும் அழுத்தி கேளுங்கள்!",
    keyNavLabel:    "விசைப்பலகை வழிசெலுத்தல்",
    keyNavDesc:     "Tab & Enter விசைகளை பயன்படுத்துங்கள்!",
    motionLabel:    "இயக்கங்களை குறைக்கவும்",
    motionDesc:     "குறைவான அசைவுகள் — குறைவான திசைதிருப்பல்!",
    a11yTip:        "குறிப்பு: NVDA மற்றும் VoiceOver போன்ற திரை வாசிப்பாளர்கள் இந்த பக்கத்துடன் நன்றாக வேலை செய்கின்றன! 🎉",
    ttsNewton:      "👨‍🔬 நியூட்டன் பற்றி",
    ttsLaw1:        "📌 விதி 1 — நிலைமம்",
    ttsLaw2:        "📌 விதி 2 — F=ma",
    ttsLaw3:        "📌 விதி 3 — செயல் & எதிர்வினை",
    heroTitle:      "குழந்தைகளுக்கான நியூட்டன் இயக்க விதிகள்! 🌟",
    heroSub:        "வேடிக்கையான அனிமேஷன்கள் மற்றும் சோதனைகளுடன் பொருட்கள் எப்படி நகர்கின்றன என்று கண்டறியுங்கள்!",
    lawPreview:     "நியூட்டனின் முதல் விதி: வெளி விசை இல்லாமல் ஓய்வில் இருக்கும் பொருள் ஓய்வில் இருக்கும்! 🍎",
    law1Title:      "நிலைமை விதி",
    law1Desc:       "பொருட்கள் தானாக நகர்வதில்லை — அவற்றுக்கு தள்ளுதல் அல்லது இழுத்தல் தேவை!",
    law2Title:      "விசை = நிறை × முடுக்கம்",
    law2Desc:       "கடினமாக தள்ளு → வேகமாக செல்!",
    law3Title:      "செயல் & எதிர்வினை",
    law3Desc:       "ஒவ்வொரு தள்ளலுக்கும் சமான எதிர் தள்ளல் உண்டு!",
    navNewton:      "👨‍🔬 நியூட்டன்",
    navLaws:        "📖 விதிகள்",
    navSim:         "🧬 உருவகப்படுத்து",
...
function setLanguage(lang) {
  ...
  document.documentElement.setAttribute('lang', lang === 'en' ? 'en' : lang + '-IN');
  ...
  const preview = document.getElementById('langPreviewText');
  if (preview) preview.textContent = t.lawPreview;

  // Update hero section
  const heroH1 = document.querySelector('.hero h1');
  if (heroH1) {
    heroH1.innerHTML = `Newton's <span>${lang === 'en' ? 'Laws of Motion' : ''}</span><br>${t.heroTitle}`;
    if (lang !== 'en') heroH1.innerHTML = `<span>${t.heroTitle}</span>`;
  }
  ...
  if (lawCards[0]) {
    const h3 = lawCards[0].querySelector('h3');
    const p  = lawCards[0].querySelector('.law-card-top > p');
    if (h3) h3.textContent = t.law1Title;
    if (p)  p.textContent  = t.law1Desc;
  }
  if (lawCards[1]) {
    const h3 = lawCards[1].querySelector('h3');
    const p  = lawCards[1].querySelector('.law-card-top > p');
    if (h3) h3.textContent = t.law2Title;
    if (p)  p.textContent  = t.law2Desc;
  }
  if (lawCards[2]) {
    const h3 = lawCards[2].querySelector('h3');
    const p  = lawCards[2].querySelector('.law-card-top > p');
    if (h3) h3.textContent = t.law3Title;
    if (p)  p.textContent  = t.law3Desc;
  }

  // Update nav buttons (leave icons, update text parts)
  const navBtns = document.querySelectorAll('.nav-links button');
  const navKeys = ['navNewton','navLaws','navSim','navGames','navQuiz','navSettings'];
  navBtns.forEach((btn, i) => {
    if (navKeys[i] && t[navKeys[i]]) btn.textContent = t[navKeys[i]];
  });
  ...
  // If TTS is on, announce the language change
  if (document.getElementById('toggleTTS')?.checked) {
    ...
    speakText(announcements[lang] || 'Language changed', t.ttsLang);
  }
}

function showLangToast(lang) {
  const names = { en: '🇬🇧 English', te: '🇮🇳 తెలుగు', hi: '🇮🇳 हिन्दी', ta: '🇮🇳 தமிழ்' };
  let toast = document.getElementById('langToast');
  if (!toast) {
    toast = document.createElement('div');
    toast.id = 'langToast';
    toast.style.cssText = `position:fixed;bottom:28px;left:50%;transform:translateX(-50%) translateY(80px);
      background:#9c59d1;color:#fff;padding:12px 28px;border-radius:50px;font-family:'Nunito',sans-serif;
      font-weight:800;font-size:0.95rem;z-index:9999;box-shadow:0 8px 24px rgba(156,89,209,0.5);
      transition:transform 0.4s cubic-bezier(0.34,1.56,0.64,1),opacity 0.4s;opacity:0;`;
    document.body.appendChild(toast);
  }
  toast.textContent = `✅ ${names[lang]}`;
...
function applyContrast(on) {
  ...
  if (on && document.getElementById('toggleTTS')?.checked) {
    speakText(currentLang === 'te' ? 'అధిక కాంట్రాస్ట్ మోడ్ ఆన్' :
              currentLang === 'hi' ? 'उच्च कंट्रास्ट मोड चालू' :
              currentLang === 'ta' ? 'அதிக மாறுபாடு பயன்முறை இயக்கப்பட்டது' :
...
function applyLargeText(on) {
  ...
  if (on && document.getElementById('toggleTTS')?.checked) {
    speakText(currentLang === 'te' ? 'పెద్ద అక్షరాల మోడ్ ఆన్' :
              currentLang === 'hi' ? 'बड़े अक्षर मोड चालू' :
              currentLang === 'ta' ? 'பெரிய எழுத்து பயன்முறை இயக்கப்பட்டது' :
              'Large text mode on');
  }
}
...
function applyKeyNav(on) {
  document.body.classList.toggle('keyboard-focus', on);
  if (on) {
...
function applyTTS(on) {
  ...
  if (ttsPanel) ttsPanel.style.display = on ? 'block' : 'none';
  if (!on) { speechSynthesis.cancel(); hideSpeakingBar(); }
  else {
    speakText(currentLang === 'te' ? 'రీడ్ అలౌడ్ ఆన్ అయింది!' :
              currentLang === 'hi' ? 'जोर से पढ़ें चालू है!' :
              currentLang === 'ta' ? 'சத்தமாக படிக்கும் பயன்முறை இயக்கப்பட்டது!' :
              'Read aloud is now on! Click a button below to hear the content.');
  }
}

// TTS content per section
const TTS_CONTENT = {
  newton: {
    en: "Isaac Newton was born in 1643 in England. He was one of the greatest scientists who ever lived! He discovered gravity when an apple fell from a tree, invented calculus, built a new type of telescope, and wrote the most important physics book ever — the Principia Mathematica in 1687, which contains his famous Three Laws of Motion!",
    te: "ఐజాక్ న్యూటన్ 1643లో ఇంగ్లాండ్‌లో జన్మించాడు. అతను ప్రపంచంలో అత్యంత గొప్ప శాస్త్రవేత్తలలో ఒకడు! చెట్టు నుండి ఒక యాపిల్ పడినప్పుడు అతను గురుత్వాకర్షణను కనుగొన్నాడు. 1687లో ప్రిన్సిపియా మ్యాథమాటికా అనే పుస్తకం రాసాడు.",
    hi: "आइज़ैक न्यूटन का जन्म 1643 में इंग्लैंड में हुआ था। वे दुनिया के सबसे महान वैज्ञानिकों में से एक थे! एक पेड़ से सेब गिरने पर उन्होंने गुरुत्वाकर्षण की खोज की। उन्होंने 1687 में प्रिंसिपिया मैथेमेटिका नामक पुस्तक लिखी।",
    ta: "ஐசக் நியூட்டன் 1643 ஆம் ஆண்டு இங்கிலாந்தில் பிறந்தார். அவர் உலகின் மிகப்பெரிய விஞ்ஞானிகளில் ஒருவர்! மரத்திலிருந்து ஒரு ஆப்பிள் விழும்போது அவர் ஈர்ப்பு விசையை கண்டுபிடித்தார்."
  },
  law1: {
    en: "Newton's First Law of Motion is the Law of Inertia! It says: An object at rest will stay at rest, and an object in motion will stay in motion, unless acted upon by an external force. Think of a football on the ground — it won't move until you kick it! Once kicked, in space it would roll forever because there is no friction to stop it!",
    te: "న్యూటన్ మొదటి చలన నియమం జడత్వ నియమం! ఇది చెప్తుంది: విశ్రాంతిలో ఉన్న వస్తువు బాహ్య శక్తి వర్తించకపోతే విశ్రాంతిలోనే ఉంటుంది. నేలపై ఒక ఫుట్‌బాల్ ఆలోచించండి — మీరు తన్నే వరకు అది కదలదు!",
    hi: "न्यूटन का पहला गति का नियम जड़त्व का नियम है! यह कहता है: विराम में रखी वस्तु तब तक विराम में रहती है जब तक कोई बाहरी बल न लगे। मैदान पर एक फुटबॉल के बारे में सोचें — जब तक आप उसे न मारें, वह नहीं हिलेगी!",
    ta: "நியூட்டனின் முதல் இயக்க விதி நிலைமை விதி! இது கூறுகிறது: வெளி விசை இல்லாமல் ஓய்வில் இருக்கும் பொருள் ஓய்வில் இருக்கும். தரையில் ஒரு கால்பந்தை நினைத்துப் பாருங்கள் — நீங்கள் உதைக்கும் வரை அது நகராது!"
  },
  law2: {
    en: "Newton's Second Law says Force equals Mass times Acceleration! Written as F equals m a. This means the harder you push something, the faster it goes. And the heavier something is, the more force you need to move it. Imagine pushing an empty shopping cart versus a full heavy cart — same push, very different speeds!",
    te: "న్యూటన్ రెండవ నియమం చెప్తుంది బలం అనేది ద్రవ్యరాశి గుణించి త్వరణం! F సమానం m a అని రాయబడుతుంది. ఇది అంటే మీరు ఏదైనా గట్టిగా నెట్టుకుంటే, అది వేగంగా వెళ్తుంది.",
    hi: "न्यूटन का दूसरा नियम कहता है बल बराबर द्रव्यमान गुणा त्वरण! F बराबर m a लिखा जाता है। इसका मतलब है कि आप जितनी जोर से कुछ धकेलते हैं, उतनी तेजी से वह जाता है।",
    ta: "நியூட்டனின் இரண்டாம் விதி கூறுகிறது விசை சமம் நிறை பெருக்கல் முடுக்கம்! F சமம் m a என்று எழுதப்படுகிறது. இதன் பொருள் நீங்கள் ஒன்றை எவ்வளவு கடினமாக தள்ளுகிறீர்களோ, அது அவ்வளவு வேகமாக செல்கிறது."
  },
  law3: {
    en: "Newton's Third Law says every action has an equal and opposite reaction! When you push on something, it pushes back on you with the same force! Think about a rocket — it blasts hot gas downward, and the gas pushes the rocket upward with the same force. That's how rockets fly into space! When you swim, you push water backward and the water pushes you forward!",
    te: "న్యూటన్ మూడవ నియమం చెప్తుంది ప్రతి చర్యకు సమాన మరియు వ్యతిరేక ప్రతిచర్య ఉంటుంది! మీరు ఏదైనా నెట్టినప్పుడు అది మీపై అదే శక్తితో తిరిగి నెట్టుతుంది! రాకెట్ గురించి ఆలోచించండి — అది వేడి గ్యాస్‌ను కిందకు నెట్టుతుంది, మరియు గ్యాస్ రాకెట్‌ను పైకి నెట్టుతుంది.",
    hi: "न्यूटन का तीसरा नियम कहता है हर क्रिया की समान और विपरीत प्रतिक्रिया होती है! जब आप किसी चीज को धकेलते हैं, तो वह उसी बल से आपको वापस धकेलती है! एक रॉकेट के बारे में सोचें — यह गर्म गैस को नीचे की ओर ब्लास्ट करती है, और गैस रॉकेट को उसी बल से ऊपर धकेलती है।",
    ta: "நியூட்டனின் மூன்றாம் விதி கூறுகிறது ஒவ்வொரு செயலுக்கும் சம மற்றும் எதிர் எதிர்வினை உண்டு! நீங்கள் ஒன்றை தள்ளும்போது அது அதே விசையில் உங்களை திரும்ப தள்ளுகிறது! ஒரு ராக்கெட்டை நினைத்துப் பாருங்கள் — அது சூடான வாயுவை கீழ்நோக்கி வெளியேற்றுகிறது, வாயு ராக்கெட்டை மேல்நோக்கி தள்ளுகிறது."
  }
};
...
function speakSection(section) {
  ...
  const content = TTS_CONTENT[section];
  if (!content) return;
  const text = content[currentLang] || content['en'];
  const ttsLang = TRANSLATIONS[currentLang]?.ttsLang || 'en-US';
...
function speakText(text, lang) {
  ...
  utter.lang = lang || TRANSLATIONS[currentLang]?.ttsLang || 'en-US';
  utter.rate = 0.88;
  utter.pitch = 1.05;
  ...
  utter.onstart = () => showSpeakingBar(text.substring(0, 40) + '...');
  utter.onend   = () => hideSpeakingBar();
  utter.onerror = () => hideSpeakingBar();
...
function showSpeakingBar(preview) {
  const bar = document.getElementById('ttsSpeakingBar');
  const txt = document.getElementById('ttsSpeakingText');
  if (bar) bar.style.display = 'flex';
  if (txt) txt.textContent = '🔊 ' + (preview || 'Reading aloud...');
}

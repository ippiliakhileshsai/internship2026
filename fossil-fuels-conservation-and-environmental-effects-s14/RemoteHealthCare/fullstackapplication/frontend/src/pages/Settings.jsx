...
export default function Settings() {
  ...
  const getRoleProfile = (currentRole) => {
    ...
    switch (currentRole) {
      case 'Admin':
        profile = { name: 'Chief Medical Director', email: 'cmd@careportal.org', roleLabel: 'System Administrator (Full Access)', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=100' }; break;
      case 'Manager':
        profile = { name: 'Clinical Manager', email: 'manager@careportal.org', roleLabel: 'Clinical Manager (Records Control)', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=100' }; break;
      case 'Accountant':
        profile = { name: 'Accounting Officer', email: 'accountant@careportal.org', roleLabel: 'Systems Accountant (Financial Controls)', avatar: 'https://images.unsplash.com/photo-1554774853-aae0a22c8aa4?auto=format&fit=crop&q=80&w=100' }; break;
      case 'Patient':
      default:
        profile = { name: 'Patient', email: 'patient@careportal.org', roleLabel: 'Registered Patient (Read-only)', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=100' }; break;
    }

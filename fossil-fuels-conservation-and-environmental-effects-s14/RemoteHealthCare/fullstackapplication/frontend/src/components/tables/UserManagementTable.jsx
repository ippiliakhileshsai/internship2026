...
import { Shield, Stethoscope, UserCheck, Plus, Search, Edit2, Trash2, X, Check, ClipboardList, CreditCard } from 'lucide-react';
...
export default function UserManagementTable({ users, onAddUser, onEditUser, onDeleteUser }) {
  ...
  const getRoleIcon = (role) => {
    switch (role) {
      ...
      case 'Doctor':
        return <Stethoscope className="w-3.5 h-3.5 text-cyan-500" />;
      case 'Manager':

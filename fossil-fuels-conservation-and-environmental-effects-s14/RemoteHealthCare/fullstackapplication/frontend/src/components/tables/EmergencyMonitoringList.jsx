import { ShieldAlert, CheckCircle, Truck, Shield, MapPin } from 'lucide-react';

export default function EmergencyMonitoringList({ emergencies, onUpdateStatus, onDispatch, onTrackEmergency }) {
          ...
          emergencies.map((em) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 shrink-0 self-end sm:self-auto">
                ...
                <button
                  onClick={() => onTrackEmergency && onTrackEmergency(em)}
                  className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-white text-[10px] font-bold rounded-lg transition-all flex items-center gap-1 cursor-pointer"
                >
